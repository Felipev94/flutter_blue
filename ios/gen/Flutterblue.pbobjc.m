...
GPBObjCClassDeclaration(ProtosReadRssiResult);
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProtosReadRssiResult)
                                   messageName:@"ReadRssiResult"
                               fileDescription:&ProtosFlutterblueRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
+ (GPBDescriptor *)descriptor {
  ...
  if (!descriptor) {
    ...
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProtosConnectionPriorityRequest)
                                   messageName:@"ConnectionPriorityRequest"
                               fileDescription:&ProtosFlutterblueRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
...
#pragma mark - ProtosClearGattCache

@implementation ProtosClearGattCache

@dynamic remoteId;

typedef struct ProtosClearGattCache__storage_ {
  uint32_t _has_storage_[1];
  NSString *remoteId;
} ProtosClearGattCache__storage_;
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "remoteId",
        .dataTypeSpecific.clazz = Nil,
        .number = ProtosClearGattCache_FieldNumber_RemoteId,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(ProtosClearGattCache__storage_, remoteId),
        .flags = (GPBFieldFlags)(GPBFieldOptional | GPBFieldClearHasIvarOnZero),
        .dataType = GPBDataTypeString,
      },
    };
    GPBDescriptor *localDescriptor =
        [GPBDescriptor allocDescriptorForClass:GPBObjCClass(ProtosClearGattCache)
                                   messageName:@"ClearGattCache"
                               fileDescription:&ProtosFlutterblueRoot_FileDescription
                                        fields:fields
                                    fieldCount:(uint32_t)(sizeof(fields) / sizeof(GPBMessageFieldDescription))
