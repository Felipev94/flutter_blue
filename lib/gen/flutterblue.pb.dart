...
class ConnectionPriorityRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConnectionPriorityRequest', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'remoteId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectionPriorityRequest copyWith(void Function(ConnectionPriorityRequest) updates) => super.copyWith((message) => updates(message as ConnectionPriorityRequest)) as ConnectionPriorityRequest;
...
class ClearGattCache extends $pb.GeneratedMessage {
  factory ClearGattCache({
    $core.String? remoteId,
  }) {
    final $result = create();
    if (remoteId != null) {
  ...
  ClearGattCache._() : super();
  factory ClearGattCache.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ClearGattCache.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ClearGattCache', createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'remoteId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ClearGattCache clone() => ClearGattCache()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClearGattCache copyWith(void Function(ClearGattCache) updates) => super.copyWith((message) => updates(message as ClearGattCache)) as ClearGattCache;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ClearGattCache create() => ClearGattCache._();
  ClearGattCache createEmptyInstance() => create();
  static $pb.PbList<ClearGattCache> createRepeated() => $pb.PbList<ClearGattCache>();
  @$core.pragma('dart2js:noInline')
  static ClearGattCache getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ClearGattCache>(create);
  static ClearGattCache? _defaultInstance;
