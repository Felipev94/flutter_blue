...
final $typed_data.Uint8List readRssiResultDescriptor = $convert.base64Decode(
    'Cg5SZWFkUnNzaVJlc3VsdBIbCglyZW1vdGVfaWQYASABKAlSCHJlbW90ZUlkEhIKBHJzc2kYAi'
    'ABKAVSBHJzc2k=');

@$core.Deprecated('Use connectionPriorityRequestDescriptor instead')
const ConnectionPriorityRequest$json = {
...
final $typed_data.Uint8List connectionPriorityRequestDescriptor = $convert.base64Decode(
    'ChlDb25uZWN0aW9uUHJpb3JpdHlSZXF1ZXN0EhsKCXJlbW90ZV9pZBgBIAEoCVIIcmVtb3RlSW'
    'QSGgoIcHJpb3JpdHkYAiABKA1SCHByaW9yaXR5');

@$core.Deprecated('Use clearGattCacheDescriptor instead')
const ClearGattCache$json = {
  '1': 'ClearGattCache',
  '2': [
    {'1': 'remote_id', '3': 1, '4': 1, '5': 9, '10': 'remoteId'},
  ],
...
/// Descriptor for `ClearGattCache`. Decode as a `google.protobuf.DescriptorProto`.
